...
void loop(){
 ...
 if (pirstatus == LOW) {PIR = "Awas!";}  
  ...
  String data="/"+String(PIR)+"/"+String(SON)+"/"+String(WAT)+"/"+String("Bagus")+"/"+String(DHT.temperature,1)+"/"+String(DHT.humidity,1)+"/"+String(MKN)+"/"+String(MND)+"/";
  Serial.println(data);
  delay(1000);
